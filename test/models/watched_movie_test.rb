...
class WatchedMovieTest < ActiveSupport::TestCase
    ...
    test "watched movie" do
        watched = @user.watched_movies.build(movie_id: @movie.id, watched: true, watched_date: DateTime.now)
    ...
    test "watched movie duplicate" do
        ...
        watched2 = @user.watched_movies.build(movie_id: @movie.id, watched: true, watched_date: DateTime.now)
        watched2.save
