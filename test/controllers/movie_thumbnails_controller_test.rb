...
class MovieThumbnailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movie_thumbnail" do
    assert_difference("MovieThumbnail.count") do
      post movie_thumbnails_url,
           params:
           { movie_thumbnail:
             {
               caption: @movie_thumbnail.caption,
               file_size: @movie_thumbnail.file_size,
               movie_id: @movie_thumbnail.movie_id,
               path: @movie_thumbnail.path,
               removed: @movie_thumbnail.removed,
               status: @movie_thumbnail.status,
               view_status: @movie_thumbnail.view_status
             } }
    end
  ...
  test "should update movie_thumbnail" do
    patch movie_thumbnail_url(@movie_thumbnail),
          params:
          {
            movie_thumbnail:
            {
